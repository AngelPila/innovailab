...
class TramitesService {
  ...
  detectarIntencion(mensaje: string): Tramite | null {
    ...
    const mapeoIntenciones: Record<string, string> = {
      ...
      ruc: 'inscripcion_ruc_persona_natural',
      'inscripcion ruc': 'inscripcion_ruc_persona_natural',
      'inscripción ruc': 'inscripcion_ruc_persona_natural',
      'registro unico': 'inscripcion_ruc_persona_natural',
      'registro único': 'inscripcion_ruc_persona_natural',
      'actualizar ruc': 'actualizacion_ruc',
      'actualizacion ruc': 'actualizacion_ruc',
      'actualización ruc': 'actualizacion_ruc',
      'clave sri': 'clave_sri_en_linea',
      'sri en linea': 'clave_sri_en_linea',
      'sri en línea': 'clave_sri_en_linea',
      'certificado tributario': 'certificado_cumplimiento_tributario',
      'cumplimiento tributario': 'certificado_cumplimiento_tributario',
      'declaracion renta': 'declaracion_impuesto_renta',
      'declaración renta': 'declaracion_impuesto_renta',
      'impuesto renta': 'declaracion_impuesto_renta',
      'convenio pago': 'convenio_pago_sri',
      'convenio sri': 'convenio_pago_sri',
      'fraccionar deuda': 'convenio_pago_sri',
      'reclamo sri': 'reclamo_administrativo_sri',
      'impugnar multa': 'reclamo_administrativo_sri',
      'reclamar sri': 'reclamo_administrativo_sri',
    };
